    ...
    <div class="w-full pb-40"> 
        <form class="space-y-6" action="{{ route('admin.post.create.post') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="mt-2">
                    <textarea id="editor" name="post" class="pl-2 pt-1 rounded-md w-full ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                </div>
            </div>
