...
<div class="py-4 sm:ml-64">
    <div class="sm:mx-auto sm:w-4/5 flex mt-12 gap-1.5 items-baseline w-4/5">
        ...
        @if ($categories != null)
            ...
            @endif
        @else
        <p class="text-sm align-text-bottom">Showing 0 category</p>
        @endif
    </div>
    ...
    <div class="sm:mx-auto sm:w-4/5 flex mt-12 gap-1.5 items-baseline w-4/5">
        <a href="{{route('admin.category.create')}}" class="rounded-md bg-indigo-600 px-3 py-1 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create Category</a>
    </div>
