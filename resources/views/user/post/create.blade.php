    ...
    <div class="w-full pb-40"> 
        <form class="space-y-6" action="{{ route('create.post') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="text-sm mt-1.5 text-slate-600">Type "," if you want to add multiple tags. The tags will also automatically be created if they do not exist.</div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2">
                    <textarea id="editor" rows="10" name="post"></textarea>
                </div>
            </div>
